                        ...
                        for (PermissionRequest permission : permissions) {
                            if (token != null) {
                                if (shouldShowRequestPermissionRationale(permission.getName())) {
                                    ...
                                    titleTextView.setText("Why permissions");
                                    messageTextView.setText("Permissions for SMS, call, and location are required to enable " +
                                            "functionalities such as sending alerts via text messages, making phone calls, " +
                                            "and accessing the device's location for safety and communication purposes");
                                    ...
                                    laterButton.setOnClickListener(v -> {
                                        ...
                                        // Handle 'Do it later' button click
                                    });
...
//                                            .show();
                ...
                .withErrorListener(error -> {
                    Toast.makeText(getActivity(), "Please turn on permission otherwise app will not work! ", Toast.LENGTH_SHORT).show();
                    showSettingsDialog();
                })
                .onSameThread()
                .check();
...
//        builder.setTitle("Need Permissions");
        ...
        Button yesButton = dialogView.findViewById(R.id.yesButton);
        Button laterButton = dialogView.findViewById(R.id.laterButton);
        yesButton.setText("Go to setting");

        titleTextView.setText("Need Permissions");
        messageTextView.setText("This app needs permission to use this feature. You can grant them in app settings.");
...
public void showGeoAlert() {
    ...
    titleTextView.setText("Geo Fencing");
    messageTextView.setText("You are trying to set your safe location. For setting the safe location, you must be at your safe location.");
